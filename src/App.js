...
export default function App() {
    ...
    useEffect(() => {
        ...
        if (token === undefined || token === null) {
            ...
            if (
                urlCurrent === process.env.REACT_APP_URL_ROOT ||
                urlCurrent === process.env.REACT_APP_URL_LOGIN
            ) {
    ...
    return (
        <div>
            ...
            <Switch>
                ...
                <Route
                    exact
                    path={process.env.REACT_APP_URL_LIST_USER}
                    component={ListUser}
                />
                <Route
                    exact
                    path={process.env.REACT_APP_URL_ADD_USER}
                    component={AddUser}
                />
                <Route
                    exact
                    path={process.env.REACT_APP_URL_EDIT_USER}
                    component={EditUser}
                />
            </Switch>
        </div>
